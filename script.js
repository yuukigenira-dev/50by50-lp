...
(function () {
  ...
  var ENTRIES = [
    ...
    { no: "IV", en: "WORLD", jp: "レゾナンス・ウォーク", chip: "公開中", live: true, art: "assets/images/entry-world.webp",
      kicker: "IV ── WORLD", title: "レゾナンス・ウォーク",
      desc: "御影泪／SHADEの観測記録を辿り、白と青紫の幻想都市を歩く簡易メタバース。",
      cta: "観測をはじめる", href: "resonance-walk/" },
    { no: "V", en: "PLAY-01", jp: "繋げるパズルゲーム", chip: "COMING SOON", live: false, art: "assets/images/entry-puzzle.webp",
      kicker: "V ── PLAY-01", title: "繋げるパズルゲーム",
      desc: "ふたりの音を繋げて共鳴させるパズル。ただいま準備中。",
      cta: "近日公開", href: null },
    { no: "VI", en: "PLAY-02", jp: "リズムゲーム", chip: "COMING SOON", live: false, art: "assets/images/entry-rhythm.webp",
      kicker: "VI ── PLAY-02", title: "リズムゲーム",
